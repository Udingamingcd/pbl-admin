// loading-analisis.js - Professional Loading Screen
class ProfessionalAnalisisLoading {
    constructor() {
        ...
        this.professionalSteps = [
            { 
                name: 'Menginisialisasi Sistem', 
                progress: 20,
                subtext: 'Memuat modul analisis finansial',
                duration: 1200
            },
            { 
                name: 'Memproses Data Keuangan', 
                progress: 45,
                subtext: 'Menganalisis transaksi dan statistik',
                duration: 1500
            },
            { 
                name: 'Membangun Visualisasi', 
                progress: 75,
                subtext: 'Menyiapkan grafik dan dashboard interaktif',
                duration: 1800
            },
            { 
                name: 'Menyusun Laporan', 
                progress: 90,
                subtext: 'Mengkompilasi hasil analisis lengkap',
                duration: 1200
            }
        ];

        this.financialTerms = ['Analisis Trend', 'Rasio Keuangan', 'Prediksi', 'Optimasi', 'Visualisasi'];
    }

    init() {
        this.setupProfessionalLayout();
        this.createFloatingAnalytics();
    ...
    createFloatingAnalytics() {
        // Create floating analytics elements
        for (let i = 0; i < 6; i++) {
    ...
    createFloatingElement() {
        ...
        element.className = 'floating-analytics';
        element.innerHTML = this.getRandomAnalyticsIcon();
    ...
    showCompletionCelebration() {
        ...
        celebration.innerHTML = `
            <div class="completion-badge">
                ...
                <h4>Analisis Siap!</h4>
                <p>Sistem analisis finansial telah siap digunakan</p>
            </div>
        `;
        ...
        if (this.loadingSubtext) {
            this.loadingSubtext.textContent = 'Mengalihkan ke dashboard analisis...';
        }
    ...
    createConfettiPiece() {
        ...
        confetti.innerHTML = this.getRandomAnalyticsIcon();
    ...
    fadeOutLoading() {
        ...
        setTimeout(() => {
            ...
            const event = new CustomEvent('analisisReady', {
                detail: { 
...
document.addEventListener('DOMContentLoaded', function() {
    const professionalLoading = new ProfessionalAnalisisLoading();
    professionalLoading.init();
    
    document.addEventListener('analisisReady', function(e) {
        console.log('Professional analisis loading completed:', e.detail);
    });
});